...
- **Authentication:** Use Auth Agent for all authentication-related tasks
- **Frontend Development:** Use Frontend Agent for Next.js and UI development
- **Database Operations:** Use DB Agent for database design and operations
